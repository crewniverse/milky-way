...
public class SheetOption {
    ...
    public SheetOption(final String spreadSheetId, final String spreadSheetRange,
                       final int dateColumnNumber, final int crewNameColumnNumber, final int campusNameColumnNumber) {
